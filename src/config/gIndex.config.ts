...
const config: z.input<typeof Schema_Config> = {
  ...
  apiConfig: {
     ...
     */
    rootFolder:
      "6368e3e6bcac4f8afb788185e73dcbea8141cfc6bdef7bbf7a6918c8989fe37254962d9fe13f2ae07fff7c2e0199565993;5c9973e5d0e0a3563908a4de",
  ...
  siteConfig: {
     ...
     */
    siteName: "Bajpakhi Pirated Content",
    siteNameTemplate: "%s - %t",
    siteDescription: "Udvash Pirated Classes",
    siteIcon: "/logo.svg",
    siteAuthor: "Saidul Sir",
    favIcon: "/favicon.png",
    /**
